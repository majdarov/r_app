...
const ProfileInfo = props => {
  ...
  if (props.profilePage.showTextArea) {
  ...
  function editDescription(e) {
    ...
    props.profilePage.toggleShowTextArea();
  ...
  function txtAreaFocusOut(e) {
    ...
    props.profilePage.toggleShowTextArea();
    document.querySelector("[class*='descriptionBlock'] button").removeAttribute('disabled');
  }

  return (
    <div>
      <div className={s.image}>
        <img src="Explore_How_To_Take_Great_Landscape_Photography_KV.webp" alt="..." />
      </div>
